            ...
            {categories.map((category, index) => (
                ...
                >
                    ...
                    <div className="relative z-10">
                        <div 
                            className={`h-12 w-12 ${isCustomTheme ? '' : colors.primary} mb-3 flex items-center justify-center rounded-2xl shadow-md`}
                    ...
                    {selectedItem === category.name && (
                        <div 
                            className={`absolute inset-0 ${isCustomTheme ? '' : colors.primary} opacity-10`}
                            style={isCustomTheme ? { backgroundColor: customColor } : {}}
                        ></div>
                    )}
                </div>

...
const ShopOwnerDashboardScreen = () => {
    ...
    const dashboardData = {
        ...
        todayScans: 47,
        weeklyTransactionAmount: 12508,
        averageRating: 4.5,
        totalCustomers: 324,
        recentScans: [
            { id: 'BW-12345', time: '14:23', amount: '€85.00', customer: 'John D.' },
            { id: 'BW-67890', time: '14:15', amount: '€52.50', customer: 'Maria S.' },
            { id: 'BW-54321', time: '14:08', amount: '€127.50', customer: 'Alex K.' },
        ],
    };
            ...
            <div className="relative mx-auto min-h-screen max-w-sm shadow-lg">
                ...
                <div className="space-y-6 p-4">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    <i className="fas fa-euro-sign mr-3 text-lg" style={{ color: customColor }}></i>
                                    <div>
                                        <p className={`${getTextClass('primary')} text-sm font-medium`}>Total Transaction Amount</p>
                                        <p className={`${getTextClass('tertiary')} text-xs`}>Weekly summary</p>
                                    </div>
                                </div>
                                <span className="text-xl font-bold" style={{ color: customColor }}>
                                    €{dashboardData.weeklyTransactionAmount}
                                </span>
                            </div>
                    ...
                    <div className={`${getCardBgClass()} rounded-xl p-4`} style={getShadowStyle('lg', 0.1)}>
                        <div className="mb-4 flex items-center justify-between">
                            <h3 className={`${getTextClass('primary')} font-semibold`}>Recent Transactions</h3>
                            <button
